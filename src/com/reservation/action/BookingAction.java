...
public class BookingAction {
	...
	public String execute() throws Exception {
		...
		resbean.setChechinDte(null);
		String ind = resbean.getChechinDte();
		resbean.setChechoutDte(null);
		String outd = resbean.getChechoutDte();
		resbean.setNoOfGuests(2);
		int noguesst = resbean.getNoOfGuests();
		resbean.setNoOfRms(2);
		int noroms = resbean.getNoOfRms();
		resbean.setPersonId(1);
		int pid = resbean.getPersonId();
		resbean.setRoomType("master");
		String rtype = resbean.getRoomType();
		service.createReservation(resbean);
