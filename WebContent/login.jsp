                                            ...
                                            <div class="well">
                                                <form id="loginForm" method="POST" action="/login/" novalidate="novalidate">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon" id="UserEmail"><i class="fa fa-user" title="Enter Your Username"></i></span>
                                                            <input type="text" class="form-control" id="username" name="username" value="" required title="Please enter your current username" placeholder="Enter Username" />
                                                        </div>
                                                        <span class="help-block"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon" id="UserEmail"><i class="fa fa-user" title="Enter Your new Password"></i></span>
                                                            <input type="password" class="form-control" id="username" name="password" value="" required title="Please enter your new password" placeholder="Enter new Password" />
                                                        </div>
                                                        <span class="help-block"></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-addon" id="UserEmail"><i class="fa fa-user" title="Enter confirm Your new Password"></i></span>
                                                            <input type="password" class="form-control" id="newusername" name="password" value="" required title="Please confirm your new password" placeholder="Confirm new Password" />
                                                        </div>
                                                        <span class="help-block"></span>
                                                    </div>
